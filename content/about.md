...
I use this site to share thoughts that might aid others working on similar problems.

> The views and opinions expressed on this blog are solely my own and do not reflect those of my employer. Any content I publish here is written in my personal capacity and should not be attributed to any organization I am affiliated with.
...
### Cloud Operations Engineer — Zscaler, India
`December 2014 – August 2015`

- Built Elasticsearch and Logstash pipelines for monitoring and alerting.
- Carried out Zscaler Cloud Operations, build, and maintenance.
<br>
<br>

### Sr. System Administrator — Texas Instruments, India
`July 2012 – October 2014`

- Deployed and managed Cisco Switches and Hitachi SAN Storage solutions.
- Automated storage usage metrics for capacity planning.
